...
const ENDPOINT = `${API_URL}/baseline`;
const CASES_FILE = '../data/evaluation-cases.json';
const OUTPUT_FILE = '../output/baseline-results.json';
...
async function runBaseline() {
  try {
    ...
    console.log(`Running baseline evaluation on ${cases.length} cases...`);
    ...
    console.log(`Baseline evaluation complete. Results saved to ${OUTPUT_FILE}`);
